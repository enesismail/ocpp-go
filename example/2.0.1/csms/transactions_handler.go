...
import "github.com/enesismail/ocpp-go/ocpp2.0.1/transactions"
...
func (c *CSMSHandler) OnTransactionEvent(chargingStationID string, request *transactions.TransactionEventRequest) (response *transactions.TransactionEventResponse, err error) {
	...
	case transactions.TransactionEventTypeStarted:
	...
	case transactions.TransactionEventTypeUpdated:
	...
	case transactions.TransactionEventTypeEnded:
